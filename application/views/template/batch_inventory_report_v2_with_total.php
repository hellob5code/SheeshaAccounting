        ...
        <table style="width: 100%;border: 1px solid gray;" cellspacing="0" cellpadding="3">
            ...
            <?php foreach ($products as $product) { ?>
                <tr>
                    ...
                    <td class="right-align"><?php echo number_format($product->purchase_cost,2); ?></td>
                    <td class="right-align"><?php echo number_format($product->CurrentQty * $product->purchase_cost,2); ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
